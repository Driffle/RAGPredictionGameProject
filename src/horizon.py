...
ANNUAL_EVENTS = [
    ...
    {"name": "Nintendo Direct", "month": 9, "start_day": 12, "end_day": 12, "category": "Gaming", "related_game": "Nintendo franchises", "event_type": "Digital Showcase", "wikipedia": "Nintendo_Direct", "alias": "Nintendo Direct (September)"},
